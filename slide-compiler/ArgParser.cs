...
namespace DiagnosticHelper
{
    ...
    /// </summary>
    /// <remarks>
    /// This class is based off the WordCount version from the Framework SDK
    ...
    internal abstract class ArgParser
    {
                              ...
                              String [] switchChars )
        {
            ...
            {
                throw new ArgumentException ("flagSymbols" );
            }
            if ( ( null == switchChars ) || ( 0 == switchChars.Length ) )
            {
                throw new ArgumentException ("switchChars" );
            }
        ...
        /// Thrown if <paramref name="args"/> is null or Nothing.
        /// </exception>
